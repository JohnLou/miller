 ...
 */
HostBase.prototype.connectRedis = function(redisHost) {
    var self = this;
    ...
    self.redisServer = redis.createClient(6379, redisHost, {retry_max_delay: 60000});

    self.redisServer.on("connect", function() {
        //
    });

    self.redisServer.on("error", function(msg) {
